      ...
      try {
        ...
        const cleanList = raw
          .map((row) => ({
            ...
            bniChapter:
              row.bniChapter || row.bni_chapter || row.Chapter || row.chapter || undefined,
      ...
      <Dialog open={showAdd} onOpenChange={setShowAdd}>
        <DialogContent className="max-w-md bg-white">
          <DialogHeader>
            ...
            <DialogDescription>
              Create a new BNI contact entry in the outreach logs.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="text-xs text-slate-500 bg-slate-50 p-3 rounded-lg border">
              ...
              <p className="font-mono">
                name *, company, designation, bniChapter, phone, email, linkedin, status, medium,
                owner, remark
              </p>
